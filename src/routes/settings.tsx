              ...
              <section class="card p-4">
                <div class="flex items-center justify-between mb-4">
                  <div class="flex items-center gap-2">
                    <svg
                      class="w-[18px] h-[18px] text-[var(--accent)]"
                      fill="currentColor"
                      viewBox="0 0 24 24"
                    >
                  ...
                  <div class="mb-4 p-4 bg-[var(--bg-tertiary)] rounded-lg border border-[var(--border-subtle)]">
                    <div class="grid grid-cols-2 gap-3 mb-3">
                      ...
                      <input
                        ...
                        onInput={(e) =>
                          setOrgDescription(e.currentTarget.value)
                        }
              ...
              <Show when={selectedOrgId()}>
                <section class="card p-4">
                  <div class="flex items-center justify-between mb-4">
                    <div class="flex items-center gap-2">
                      <svg
                        class="w-[18px] h-[18px] text-[var(--warning)]"
                        fill="currentColor"
                        viewBox="0 0 24 24"
                      >
                    ...
                    <div class="mb-4 p-4 bg-[var(--bg-tertiary)] rounded-lg border border-[var(--border-subtle)]">
                      <div class="grid grid-cols-2 gap-3 mb-3">
                        ...
                        <input
                          ...
                          onInput={(e) =>
                            setBucketEndpoint(e.currentTarget.value)
                          }
                        ...
                        <input
                          ...
                          value={bucketRegion()}
                          onInput={(e) =>
                            setBucketRegion(e.currentTarget.value)
                          }
                      ...
                      <div class="mb-3 p-3 bg-[var(--bg-secondary)] rounded border border-[var(--border-subtle)]">
                        <div class="text-xs font-medium text-[var(--text-secondary)] mb-2">
                      ...
                      {(bucket) => (
                        <div class="flex items-center justify-between p-3 rounded-lg bg-[var(--bg-tertiary)] border border-[var(--border-subtle)] hover:border-[var(--border-default)] transition-colors">
                          <div class="flex-1 min-w-0">
                            ...
                            <div class="text-xs text-[var(--text-tertiary)] mt-0.5 font-mono">
                              {bucket.bucketName}
                            </div>
